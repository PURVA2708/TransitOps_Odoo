...
VALUES
  ('c0a80101-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'manager@transitops.in', extensions.crypt('demo1234', extensions.gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Tirth Patel","role":"Fleet Manager"}', 'authenticated', 'authenticated'),
  ('c0a80101-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'driver@transitops.in', extensions.crypt('demo1234', extensions.gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Alex Kumar","role":"Driver"}', 'authenticated', 'authenticated'),
  ('c0a80101-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'safety@transitops.in', extensions.crypt('demo1234', extensions.gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Sana Iqbal","role":"Safety Officer"}', 'authenticated', 'authenticated'),
  ('c0a80101-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'finance@transitops.in', extensions.crypt('demo1234', extensions.gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Meera Nair","role":"Financial Analyst"}', 'authenticated', 'authenticated')
ON CONFLICT (id) DO NOTHING;

-- 2. Seed Public Profiles (just in case trigger was not active or for validation)
INSERT INTO public.profiles (id, name, role)
VALUES
  ('c0a80101-0000-0000-0000-000000000001', 'Tirth Patel', 'Fleet Manager'),
  ('c0a80101-0000-0000-0000-000000000002', 'Alex Kumar', 'Driver'),
  ('c0a80101-0000-0000-0000-000000000003', 'Sana Iqbal', 'Safety Officer'),
  ('c0a80101-0000-0000-0000-000000000004', 'Meera Nair', 'Financial Analyst')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, role = EXCLUDED.role;

-- 3. Seed Vehicles
INSERT INTO public.vehicles (id, reg, name, type, capacity, odometer, cost, status)
VALUES
...
-- 4. Seed Drivers
INSERT INTO public.drivers (id, name, license, category, expiry, contact, score, status)
VALUES
...
-- 5. Seed Trips
INSERT INTO public.trips (id, source, dest, vehicle_id, driver_id, cargo, distance, revenue, status, final_odometer, fuel_consumed)
VALUES
...
-- 6. Seed Maintenance
INSERT INTO public.maintenance (id, vehicle_id, date, description, cost, status)
VALUES
...
-- 7. Seed Expenses
INSERT INTO public.expenses (id, vehicle_id, date, type, amount, notes)
VALUES
